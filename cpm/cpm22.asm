...
; Note, I had some modifications - LGB
...
CPM_END_ADDRESS:
	ASSERT  CPM_END_ADDRESS - CPM_START_ADDRESS = CPM_EXACT_SIZE, CPM system size problem.
	ASSERT (CPM_START_ADDRESS & 0xFF) = 0, CPM system start address is not 256 byte aligned.
	ASSERT (CPM_END_ADDRESS   & 0xFF) = 0, CPM system end address is not 256 byte aligned.

M65BDOS_CBASE = CBASE
M65BDOS_FBASE = FBASE

M65BDOS_START_BDOS = CPM_START_ADDRESS
M65BDOS_END_BDOS   = CPM_END_ADDRESS
M65BDOS_SIZE_BDOS  = CPM_END_ADDRESS - CPM_START_ADDRESS
