...
BDOS_END_ADDRESS:
	ASSERT BDOS_END_ADDRESS - BDOS_START_ADDRESS = BDOS_EXACT_SIZE
	ASSERT (BDOS_START_ADDRESS & 0xFF) = 0
	ASSERT (BDOS_END_ADDRESS   & 0xFF) = 0

M65BDOS_CBASE = CBASE
M65BDOS_FBASE = FBASE
;M65_BDOS_END_ADDRESS = BDOS_END_ADDRESS
;M65_BDOS_SIZE = BDOS_EXACT_SIZE

M65BDOS_START_BDOS = BDOS_START_ADDRESS
M65BDOS_END_BDOS = BDOS_END_ADDRESS
M65BDOS_SIZE_BDOS = BDOS_END_ADDRESS - BDOS_START_ADDRESS
