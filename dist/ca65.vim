...
syn match a65Opcode	"\<PLZ\($\|\s\)" nextgroup=a65Address
...
syn match a65Opcode	"\<TZA\($\|\s\)" nextgroup=a65Address
...
syn match a65Opcode	"\<INZ\($\|\s\)" nextgroup=a65Address
syn match a65Opcode	"\<INA\($\|\s\)" nextgroup=a65Address
...
syn match a65Opcode	"\<DEZ\($\|\s\)" nextgroup=a65Address
syn match a65Opcode	"\<DEA\($\|\s\)" nextgroup=a65Address
...
syn match a65Opcode	"\<PHZ\($\|\s\)" nextgroup=a65Address
...
syn match a65Opcode	"\<TAZ\($\|\s\)" nextgroup=a65Address

syn match a65Opcode	"\<MAP\($\|\s\)" nextgroup=a65Address
syn match a65Opcode	"\<EOM\($\|\s\)" nextgroup=a65Address
...
syn match a65Type	"\(^\|\s\)\.res\($\|\s\)"
syn match a65Type	"\(^\|\s\)\.code\($\|\s\)"
syn match a65Type	"\(^\|\s\)\.org\($\|\s\)"
syn match a65Type	"\(^\|\s\)\.macro\($\|\s\)"
syn match a65Type	"\(^\|\s\)\.endmacro\($\|\s\)"
syn match a65Type	"\(^\|\s\)\.proc\($\|\s\)"
syn match a65Type	"\(^\|\s\)\.endproc\($\|\s\)"
syn match a65Type	"\(^\|\s\)\.segment\($\|\s\)"
syn match a65Type	"\(^\|\s\)\.incbin\($\|\s\)"
syn match a65Type	"\(^\|\s\)\.include\($\|\s\)"
syn match a65Type	"\(^\|\s\)\.define\($\|\s\)"
syn match a65Type	"\(^\|\s\)\.export\($\|\s\)"
syn match a65Type	"\(^\|\s\)\.exportzp\($\|\s\)"
syn match a65Type	"\(^\|\s\)\.import\($\|\s\)"
syn match a65Type	"\(^\|\s\)\.importzp\($\|\s\)"
syn match a65Type	"\(^\|\s\)\.if\($\|\s\)"
syn match a65Type	"\(^\|\s\)\.else\($\|\s\)"
syn match a65Type	"\(^\|\s\)\.endif\($\|\s\)"
...
syn match   a65Comment	";.*" contains=a65Todo
